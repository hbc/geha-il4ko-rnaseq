...
library(logging)
basicConfig()
project_summary = "/Users/rory/cache/geha-rnaseq/results/2016-02-04_geha-rnaseq/project-summary.csv"
counts_file = "/Users/rory/cache/geha-rnaseq/results/2016-02-04_geha-rnaseq/combined.counts"
tx2genes_file = "/Users/rory/cache/geha-rnaseq/results/2016-02-04_geha-rnaseq/tx2gene.csv"
...
Here is the breakdown by biotype:

```{r by-biotype-table}
DT::datatable(table(subset(res, padj < 0.05)$gene_biotype))
```
